...
<script type="text/javascript">
	function submitForm() {
		<g:if test="${!canPlay}">alert("您没有推荐两名用户关注，或此机会已使用，无法参与抽奖，等待下次机会吧");</g:if>
...
<g:form name="saveForm" action="saveInvitation">
<g:hiddenField name="id" value="${subscriber.openId }"/>
</g:form>

<div class="content">
<g:if test="${canPlay}">
<h2>确认使用推荐两名用户关注红包，参与抽奖!</h2>
</g:if>
<g:else>
<h2>您没有推荐两名用户关注，或此机会已使用，无法参与抽奖!</h2>
</g:else>
<p><img src="${resource(dir:'images/friends.png')}" style="width:40%;" /></p>

<p>
<a href="javascript:submitForm()"><span class="button  blue">确认抽奖</span></a>	
</p>
<h4 class="share_alert">点击“确认抽奖”，将使用推荐两名用户关注参与抽奖。</h4>
