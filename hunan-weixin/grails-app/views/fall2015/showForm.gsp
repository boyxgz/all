...
<wx:registerJsapi queryString="lateSpring2015/cardRecharging/" apiList="'onMenuShareAppMessage','onMenuShareTimeline'"/>
...
<g:form action="saveForm" name="saveForm" enctype="multipart/form-data">
...
<!-- 
 ...
 -->
  ...
  <tr>
    <td>充值凭证照片</td>
    <td><input name="reciptFile" type="file" accept="image/*" capture="camera"></td>
  </tr>
</table>
</g:form>
<p>
