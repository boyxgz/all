...
<html>
	...
	<body>
		<a href="#edit-fall2015Voucher" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-fall2015Voucher" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${fall2015VoucherInstance?.version}" />
				<fieldset class="form">
