...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'report.subscriberBranchDaily.label', default: 'RegisterPrize')}" />
		<title><g:message code="report.subscriberBranchDaily.label" args="[entityName]" /></title>
	</head>
	<body>
		...
		<div>
			<h1>粉丝汇总报表</h1>
			<g:form action="subscriberBranchDaily">
				<fieldset class="form">
