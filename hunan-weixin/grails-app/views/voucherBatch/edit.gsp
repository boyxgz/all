...
<html>
	...
	<body>
		<a href="#edit-voucherBatch" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-voucherBatch" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${voucherBatchInstance?.version}" />
				<fieldset class="form">
