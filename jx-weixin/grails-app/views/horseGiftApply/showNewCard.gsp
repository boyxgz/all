...
<html>
	...
	<body>
	<g:form method="post" action="saveNewCard">
			...
			<div class="x-field" >
				...
				<div class="x-component-outer" style="width: 70% !important;">
					<div class="x-field-input" >
						<g:textField name="holderName" value="${apply?.holderName }"/>
					</div>
				</div>
			</div>
			<div class="x-field" >
				...
				<div class="x-component-outer" style="width: 70% !important;">
					<div class="x-field-input" >
						<g:textField name="holderSId" value="${apply?.holderSId }"/>
					</div>
				</div>
			</div>
			
		</div>
		<p class="alignCenter"><g:submitButton name="submit" value="提交"/></p>
	</g:form>
	</body>
</html>
