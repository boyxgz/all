		...
		<div id="show-horseGiftApply" class="content scaffold-show" role="main">
			...
			<g:form>
				...
				<fieldset class="buttons">
					...
					<g:actionSubmit class="delete" action="passPic" value="${message(code: 'default.button.passPic.label', default: 'passPic')}" onclick="return confirm('${message(code: 'default.button.passPic.confirm.message', default: 'Are you sure?')}');" />
				</fieldset>
			</g:form>
		</div>
	</body>
