		...
		<div id="show-horseGiftApply" class="content scaffold-show" role="main">
			...
			<g:form>
				...
				<fieldset class="buttons">
					...
					<g:actionSubmit class="delete" action="unlucky" value="${message(code: 'default.button.unlucky.label', default: 'unlucky')}" onclick="return confirm('${message(code: 'default.button.unlucky.confirm.message', default: 'Are you sure?')}');" />
				</fieldset>
			</g:form>
		</div>
	</body>
