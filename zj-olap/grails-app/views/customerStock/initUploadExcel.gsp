...
<html>
	...
	<body>
		...
		<div class="nav" role="navigation">
			...
			<span class="menuButton"><g:link class="list" action="list" controller="stockExcelUpload"><g:message code="default.list.label" args="[entityName]" /></g:link></span>
			</sec:ifAnyGranted>
		</div>
		<div id="create-excelUpload" class="content scaffold-create" role="main">
			<h1><g:message code="default.createDelivery.label" /></h1>
