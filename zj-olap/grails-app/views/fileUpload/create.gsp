...
<html>
	...
	<body>
		...
		<div class="nav" role="navigation">
			...
			<span class="menuButton"><g:link class="list" action="list"><g:message code="default.list.label" args="['附件']" /></g:link></span>
		</div>
		<div id="create-fileUpload" class="content scaffold-create" role="main">
			<h1><g:message code="default.create.label" args="['附件']" /></h1>
