...
<html>
	...
	<body>
		...
		<div class="nav" role="navigation">
			...
			<span class="menuButton"><g:link class="create" action="create"  params="${['customerBranchId':customerBranch.id]}"><g:message code="default.new.label" args="[entityName]" /></g:link></span>
		</div>
		<div id="list-warningRuleToBranchCustomer" class="content scaffold-list" role="main">
			...
			<div class="paginateButtons" id="paginateButtons">
				<g:paginate total="${warningRuleToBranchCustomerInstanceTotal}" params="${['customerBranchId':customerBranch.id]}"/>
			</div>
		</div>
	</body>
</html>
